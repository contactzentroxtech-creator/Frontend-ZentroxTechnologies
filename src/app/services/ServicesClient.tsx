...
const SERVICES = [
  ...
  },
  {
    ...
    desc: "Native-quality Mobile Application services using React Native for both iOS and Android platforms — featuring smooth animations, offline support, and app store deployment.",
    features: [
      "React Native",
      "iOS & Android",
      "Push Notifications",
        ...
        <div className="max-w-4xl mx-auto relative">
          ...
          >
            ...
            <p className="text-lg text-z-muted max-w-2xl mx-auto leading-relaxed">
              From startups to enterprises — we build the digital products that
              drive real growth. Every engagement comes with transparent
              pricing, clear timelines, and dedicated support.
            </p>
          </motion.div>
        </div>
      </section>
              ...
              >
                <div>
                  <div className="flex items-center gap-3 mb-4">
                    ...
                    <div>
                      <div className="text-[10px] font-semibold uppercase tracking-widest text-z-muted">
                        Service
                      </div>
                  ...
                  <p className="text-sm font-semibold text-z-muted mb-3 italic">
                    "{svc.tagline}"
                  </p>
                  <p className="text-sm text-z-muted leading-relaxed mb-5">
                    {svc.desc}
                  </p>
                  <div className="flex flex-col gap-2 mb-6">
                    <div className="text-xs uppercase tracking-widest text-z-muted mb-1">
                      Includes
                    </div>
                    {svc.features.map((f) => (
                      <div
                        key={f}
                        className="flex items-center gap-2 text-sm text-z-muted"
                      >
                        <Check
                          size={13}
                ...
                <div className="flex flex-col justify-between">
                  <div className="glass-card bg-white/[0.02] p-6 rounded-2xl mb-4">
                    <div className="text-xs text-z-muted uppercase tracking-widest mb-1">
                      Starting From
                    </div>
                    <div className="text-3xl font-extrabold text-white mb-3">
                      {svc.startingFrom}
                    </div>
                    <div className="text-xs text-z-muted mb-4">
                      {svc.deliverable}
                    </div>
                    <div className="w-full h-px bg-z-border mb-4" />
                    <div className="text-xs text-z-muted">
                      Pricing varies based on complexity, features, and
                      timeline. All projects include free consultation.
                    </div>
                  </div>
                  <Link
                    href="/contact"
