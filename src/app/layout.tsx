...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    images: [{ url: '/og-image.png', width: 1200, height: 630, alt: 'Zentrox Technologies' }],
  },
  twitter: {
    card: 'summary_large_image',
    title: 'Zentrox Technologies',
    description: 'Premium Web Development, AI & SaaS Solutions — Mohali & Chandigarh',
    images: ['/og-image.png'],
  },
        ...
        <script
          ...
          dangerouslySetInnerHTML={{
            __html: JSON.stringify({
              ...
              contactPoint: { '@type': 'ContactPoint', telephone: '+91-8988183513', contactType: 'customer service', areaServed: 'IN', availableLanguage: ['English', 'Hindi', 'Punjabi'] },
              address: { '@type': 'PostalAddress', addressLocality: 'Mohali', addressRegion: 'Punjab', addressCountry: 'IN' },
              description: 'MSME-registered technology startup offering web development, AI solutions, SaaS development, SEO, and digital marketing.',
              foundingDate: '2023',
            }),
          }}
        />
