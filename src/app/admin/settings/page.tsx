  ...
  [
    {
      ...
      fields: [
        ...
        },
        {
          ...
          type: "text",
          group: "General",
          placeholder: "https://zentroxtechnologies.com",
        },
        ...
        },
        {
          ...
          type: "text",
          group: "General",
          placeholder: "contact.zentroxtech@gmail.com",
        },
        {
          key: "whatsapp_number",
        ...
        },
        {
          ...
          type: "text",
          group: "General",
          placeholder: "Mohali & Chandigarh, Punjab, India",
        },
      ],
    },
    {
    ...
    },
    {
      ...
      fields: [
        {
          key: "show_floating_cta",
          label: "Enable Floating CTA Bar",
          type: "boolean",
          group: "Features",
        },
        {
          key: "show_whatsapp_btn",
    ...
    },
    {
      ...
      fields: [
        ...
        {
          key: "offer_text",
          label: "Floating CTA Bar Text",
          type: "text",
          group: "Banners",
          placeholder: "Free consultation — no commitment needed",
        },
        {
          key: "offer_discount",
    ...
    },
    {
      ...
      fields: [
        ...
        {
          key: "auto_reply_leads",
          label: "Auto-reply Lead Emails",
          type: "boolean",
          group: "Integrations",
        },
      ],
...
const DEFAULTS: Record<string, any> = {
  ...
  site_url: "https://zentroxtechnologies.com",
      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-sm text-z-muted">
            Platform configuration — all changes persist to database
          </p>
        </div>
        <button
          onClick={save}
          ...
          className={`flex items-center gap-2 px-5 py-2.5 rounded-xl text-white text-sm font-semibold disabled:opacity-50 transition-all ${
            saved ? "bg-z-accent3" : "bg-z-accent hover:bg-blue-500"
          }`}
        >
          {saving ? (
            ...
            {group.fields.map((field) => (
              <div key={field.key}>
                <label className="text-xs text-z-muted uppercase tracking-widest mb-1.5 flex items-center gap-2 block">
                  {field.label}
                  {field.locked && (
                    <span className="text-[10px] px-1.5 py-0.5 rounded bg-z-gold/15 text-z-gold">
                      Locked
                    </span>
                  )}
                </label>
                {field.type === "boolean" ? (
                  ...
                  <textarea
                    ...
                    onChange={(e) =>
                      !field.locked && setValue(field.key, e.target.value)
                    }
        ...
        <div className="flex items-start gap-3">
          ...
          <div>
            <p className="text-sm font-semibold text-white mb-1">
              Sensitive Keys — Environment Variables Only
            </p>
            <p className="text-xs text-z-muted leading-relaxed mb-3">
              These must be set in Railway (backend) and Vercel (frontend) env
              vars — never in this settings panel:
            </p>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-1.5 text-xs font-mono">
              {[
                ...
                <div
                  key={k}
                  className="px-3 py-1.5 rounded-lg bg-z-dark border border-z-border text-z-accent"
                >
                  {k}
                </div>
              ))}
